...
//             <div className="w-[90%] md:w-[60%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-2 ">
//             <div className="space-y-4 m-5 shadow-xl h-[150px]" >
//                     <img src={props.imageSrc} alt="shop image" className="h-5" />
//                     <p> {props.title}</p>
//                     <Link to ="/Help">
                    

//                     <button className="bg-red-500 p-2">Add To Cart</button>
//                     </Link>
//                 </div>
...
<img src={props.image} alt="card-img" className=""/>
